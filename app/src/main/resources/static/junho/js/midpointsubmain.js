...
var destinationInputEl = document.querySelector('.midpoint .midpoint-input .destination-input input');
var addDestinaionEl = document.querySelector('.add-destination');
