...
public interface ItrJobGroupDao {
  int countAll();

  List<ItrJobGroup> findAll();

  int insert(ItrJobGroup itrJobGroup);

  ItrJobGroup findByNo(int no);

  int update(ItrJobGroup itrJobGroup);
