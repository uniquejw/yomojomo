...
public interface NoticeQuestionDao2 {
  int countAll();

  List<NoticeQuestion2> findAll();

  int insert(NoticeQuestion2 noticeQuestion2);

  NoticeQuestion2 findByNo(int no);

  int update(NoticeQuestion2 noticeQuestion2);
