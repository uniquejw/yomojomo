...
public interface FinalPurposeDao {
  int countAll();

  List<FinalPurpose> findAll();

  int insert(FinalPurpose finalpurpose);

  FinalPurpose findByNo(int no);

  int update(FinalPurpose finalpurpose);
