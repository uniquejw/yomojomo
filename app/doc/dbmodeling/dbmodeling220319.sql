...
CREATE TABLE gms_itr_jobgroup (
  itr_j_no INTEGER     NOT NULL COMMENT '직군번호', -- 직군번호
...
ALTER TABLE gms_itr_jobgroup
  MODIFY COLUMN itr_j_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '직군번호';
...
CREATE TABLE gms_itr_jobgroup_detail (
  itr_j_dta_no INTEGER     NOT NULL COMMENT '관심직군세부번호', -- 관심직군세부번호
...
ALTER TABLE gms_itr_jobgroup_detail
  MODIFY COLUMN itr_j_dta_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '관심직군세부번호';
...
CREATE TABLE gms_recruit (
  rcu_b_no     INTEGER     NOT NULL COMMENT '리쿠르팅게시판번호', -- 리쿠르팅게시판번호
...
ALTER TABLE gms_recruit
  MODIFY COLUMN rcu_b_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '리쿠르팅게시판번호';
